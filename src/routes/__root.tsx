...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Avendum builds enterprise-grade AI platforms that automate telecom network deployment, operations, and lifecycle. 11+ years, 40+ AI platforms, 150M+ edge nodes." },
